...
1. Run: cd android; ./build.sh
2. Import IntelliJ project from android/build/ directory.

The project will used the build.gradle generated by titanium, but correctly set the source path

### Dependencies ###

(TODO: is this really true?)
The plotprojects dependencies need to be set in both of these location:

- android/build.gradle
- EMA project:app/platform/android/build.gradle
...
# Orignal README from PlotProjects (I think)
...
You can find the full integration guide at our (plotprojects) website:
